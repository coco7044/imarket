...
for url in csv_data:
    ...
    if len(browser.find_elements_by_id('spec_goods')) > 0 and len(browser.find_elements_by_tag_name('tbody')[0].find_elements_by_id('spec_stock_msg')) > 4:
        ...
        color = browser.find_elements_by_tag_name('tbody')[0].find_elements_by_id('spec_stock_msg')[2].text
    else:
        continue
