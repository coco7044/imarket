    ...
    public function show($id,$option)
    {
        ...
        if($option !== " "){
            if(is_numeric($option)){
                ...
                if(empty($products[0])){
                    return redirect()->route('items.show', ['item' => $id, 'option' => ' '])
        ...
        if($category===1){
            return view('guest.show-iphone12', compact('product', 'quantity','count'));
        }elseif($category===2){
            return view('guest.show-iphone13', compact('product', 'quantity','count'));
        }elseif($category===3){
            return view('guest.show-iphone14', compact('product', 'quantity','count'));
        }elseif($category===5){
            return view('guest.show-ipad-Air', compact('product', 'quantity','count'));
        }elseif($category===4){
            return view('guest.show-ipad-min', compact('product', 'quantity','count'));
        }elseif($category===6){
            return view('guest.show-ipad-Pro', compact('product', 'quantity','count'));
        }elseif($category===7){
            return view('guest.show-mac-Air', compact('product', 'quantity','count'));
        }elseif($category===8){
            return view('guest.show-mac-Pro', compact('product', 'quantity','count'));
        }else{
            return view('guest.show', compact('product', 'quantity','count'));
        }
    }
