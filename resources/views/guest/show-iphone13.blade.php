                                            ...
                                            <div class="md:py-8">
                                                ...
                                                <div class="mb-4 md:mb-6 pt-8">
                                                    ...
                                                    <div class="flex flex-wrap gap-2" id="color">
                                                        ...
                                                        <a nama="color" value="pink" @if($product->color === 'pink') href="javascript:void(0)" @else href="{{ route('items.show',['item'=>$product->id,'option'=>'pink']) }}" @endif class="@if($product->color === 'pink')h-8 w-8 rounded-full border pink ring-2 ring-gray-800 @else h-8 w-8 pink rounded-full border ring-2 ring-transparent ring-offset-1 transition duration-100 hover:ring-gray-400 @endif"></a>
                                                        <a nama="color" value="green" @if($product->color === 'green') href="javascript:void(0)" @else href="{{ route('items.show',['item'=>$product->id,'option'=>'green']) }}" @endif class="@if($product->color === 'green')h-8 w-8 rounded-full border green ring-2 ring-gray-800 @else h-8 w-8 green rounded-full border ring-2 ring-transparent ring-offset-1 transition duration-100 hover:ring-gray-400 @endif"></a>
