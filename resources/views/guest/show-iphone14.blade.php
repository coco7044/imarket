                                            ...
                                            <div class="md:py-8">
                                                ...
                                                <div class="mb-4 md:mb-6 pt-8">
                                                    ...
                                                    <div class="flex flex-wrap gap-2" id="color">
                                                        ...
                                                        <a nama="color" value="yellow" @if($product->color === 'yellow') href="javascript:void(0)" @else href="{{ route('items.show',['item'=>$product->id,'option'=>'yellow']) }}" @endif class="@if($product->color === 'yellow')h-8 w-8 rounded-full border yellow ring-2 ring-gray-800 @else h-8 w-8 yellow rounded-full border ring-2 ring-transparent ring-offset-1 transition duration-100 hover:ring-gray-400 @endif"></a>
