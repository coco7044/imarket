...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            ...
            <form method="post" action="{{ route('admin.priceSearch.index')}}" >
                @csrf
                    <div class="p-2 w-1/2 mx-auto">
                        <div class="relative">
                            <label for="searchSite" class="leading-7 text-sm text-gray-600">検索先サイト</label>
                            <select name="category" id="searchSite" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                    ...
                    <div class="p-2 w-1/2 mx-auto">
                    <label for="search" class="leading-7 text-sm text-gray-600">出力形式</label>
